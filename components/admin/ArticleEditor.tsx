    ...
    <div className="min-h-screen bg-gray-50 font-sans pb-24">
      ...
      <header className="bg-black text-white px-6 py-4 border-b-2 border-gray-800 flex justify-between items-center sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
           ...
           <button onClick={handleSubmit} className="bg-fas-red text-white px-6 py-2 font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-black transition-colors">
             Publish Article
           </button>
        </div>
      </header>
